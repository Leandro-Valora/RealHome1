                ...
                <div className="house-info">
                    ...
                    <div className="house-form" style={{ display: showHouseForm ? 'block' : 'none' }}>
                        <form>
                            ...
                            <input type="text" id="titolo" placeholder='Richiesta appuntamento...' name="titolo" /><br />
                            <label htmlFor="descrizione">Descrizione:</label><br />
                            <textarea id="descrizione" placeholder='Vorrei fissare un appuntamento per...' name="descrizione" rows="4" cols="50"></textarea><br />
